...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;\varoast\begin{cases}f(x_1,...,x_n,0)\cong{g(x_1,...,x_n)\\f(x_1,...,x_n,y+1)\cong{h(x_1,...,x_n,y,f(x_1,...,x_n,y))}\end{cases}">

<img src="https://latex.codecogs.com/svg.latex?\Large&space;\varoast"> ще наричаме обща схема на примитивната рекурсия и ще казваме, че <img src="https://latex.codecogs.com/svg.latex?\Large&space;f"> е дефинирана чрез примитивна рекурсия от <img src="https://latex.codecogs.com/svg.latex?\Large&space;g"> и <img src="https://latex.codecogs.com/svg.latex?\Large&space;h">.
