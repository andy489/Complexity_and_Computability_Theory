...
**Твърдение 3.** Всяка примитивно рекурсивна функция е тотална.<br>
*Док-во:* Ще приложим индукция по дефиницията на ПРФ (примитивно рекурсивните функции).<br>*База*: Изходните ПРФ са тотални
- ако <img src="https://latex.codecogs.com/svg.latex?\Large&space;f=g(h_1,...,h_k)"> и <img src="https://latex.codecogs.com/svg.latex?\Large&space;g,h_1,...,h_k"> са тотални, то и <img src="https://latex.codecogs.com/svg.latex?\Large&space;f"> е тотална.
...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;f:\mathbb{N}^n\nrightarrow\mathbb{N},{\;}n=1,2,...\sim\mathbb{R}"><br><img src="https://latex.codecogs.com/svg.latex?\Large&space;A^{\ast}=\{\eps\}\cup{A}\cup{A^2}\cup{...}"> - изчислимите функции са изброимо много (т.е. нищожно малко в сравнение с всички функции, но достатъчно много за да се изучават)
