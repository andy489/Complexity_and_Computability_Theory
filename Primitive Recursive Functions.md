...
Да разгледаме функцията на Маккарти (![McCarthy 91 function](https://en.wikipedia.org/wiki/McCarthy_91_function)). Тя дава ясен пример за това, какво не е примитивна рекурсия.
