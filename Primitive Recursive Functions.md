...
*Док-во:* (индукция) Нека <img src="https://latex.codecogs.com/svg.latex?\Large&space;f_1"> и <img src="https://latex.codecogs.com/svg.latex?\Large&space;f_2"> удовлетворяват <img src="https://latex.codecogs.com/svg.latex?\Large&space;\ast">. Ще покажем, че <img src="https://latex.codecogs.com/svg.latex?\Large&space;f_1=f_2">, т.е. <img src="https://latex.codecogs.com/svg.latex?\Large&space;\forall{\overline{x}}{\:}\forall{y}">(f_1(\overline{x},y)\cong{f_2(\overline{x},y))">.
