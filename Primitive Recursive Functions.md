 ...
 *Индукционна хипотеза:* Нека за някое <img src="https://latex.codecogs.com/svg.latex?\Large&space;y{\;}:{\;}P(y)\stackrel{\text{\ast}}{\Leftrightarow}!f(\overline{x},y)">. Тогава за  <img src="https://latex.codecogs.com/svg.latex?\Large&space;y+1{\;}:{\;}f(\overline{x},y+1)\stackrel{\text{(\ast\)}}h(\overline{x},y,f(\overline{x},y))"> - също е дефинирана, защото  <img src="https://latex.codecogs.com/svg.latex?\Large&space;f(\overline{x},y)"> e дефинирана от индукционната хипотеза.
