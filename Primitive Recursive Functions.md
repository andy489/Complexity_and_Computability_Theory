 ...
 *Индукционна хипотеза:* Нека за някое <img src="https://latex.codecogs.com/svg.latex?\Large&space;y{\;}:{\;}P(y)\stackrel{\text{def.}}{\Leftrightarrow}!f(\overline{x},y)">. Тогава за <img src="https://latex.codecogs.com/svg.latex?\Large&space;y+1{\;}:{\;}f(\overline{x},y+1)\stackrel{\text{(\ast{)}}}{\cong}h">
