...
б) <img src="https://latex.codecogs.com/svg.latex?\Large&space;f_1(x,0)=x+0=x=I_{1}^{1}(x)"><br><img src="https://latex.codecogs.com/svg.latex?\Large&space;f_1(x,y+1)=x+(y+1)=\underbrace{(x+y)}_{}+1=f_1(x,y)+1=S(f_1(x,y))">.<br>
Следователно от дефиницията за *примитивно рекурсивна функция*:<br><img src="https://latex.codecogs.com/svg.latex?\Large&space;f(\overline{x},0)=g(\overline{x})"><br><img src="https://latex.codecogs.com/svg.latex?\Large&space;f(\overline{x},y+1)=h(\overline{x},y,f(\overline{x},y))"><br>формално имеме <img src="https://latex.codecogs.com/svg.latex?\Large&space;\cases{begin}f_1(x,0)=I_{1}^{1}\\f_1(x,y+1)=S(f_1(x,y))=h(x,f_1(x,y))\cases{end}">, където <img src="https://latex.codecogs.com/svg.latex?\Large&space;h(x,z)=S(z)">. Така достигнахме примитивно рекурсивни (базови) функции от десните страни на равенствата - което искахме.
